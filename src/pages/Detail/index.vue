        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!---
                 以前路由跳转，从A路由跳转到B路由，这里在加入购物车，进行路由跳转之前，发送请求
                 把你购买的产品信息通知服务器，服务器进行存储
                -->
    ...
    methods:{
      ...
      async addShopCart(){
        ...
        try{
          ...
          // 路由跳转
          // 4:在路由跳转的时候将产品信息带入下一级路由信息 简单的诗句通过 query形式给路由组件
          // 复杂数据通过会话存储（不持久化：会话结束消失）
          // 本地存储和会话存储一般存储字符串

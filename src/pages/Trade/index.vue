...
export default {
  ...
  methods:{
   ...
   async   submitOrder(){
      ...
      // 其余六个参数
      let data ={
        consignee: this.userDefaultAddressInfo.consignee, //收件人姓名
        consigneeTel: this.userDefaultAddressInfo.phoneNum, // 手机号
        deliveryAddress: this.userDefaultAddressInfo.fullAddress,// 地址
        paymentWay: "ONLINE",
        orderComment: this.msg, // 留言信息
        orderDetailList: this.orderInfo.detailArrayList, // 购物车信息
      }
